    ...
    if (!running) {
        ...
        chrome.tabs.onUpdated.addListener(function(tabId, changeInfo, tab) {
            if(changeInfo.url&&tabId==tax){
                ...
                if (changeInfo.url.indexOf("https://www.wanneroobusiness.com/membersdirectory-1/")==0){//scrap conpanies links
                console.log("scrap conpanies links")
                    chrome.tabs.executeScript(tax,{file: "/javascripts/getcompanies.js"},receiveCompanies);
                
                }
                else if(changeInfo.url.indexOf("https://www.wanneroobusiness.com/membersdirectory-1")==0)//scrap categories
                    chrome.tabs.executeScript(tax,{file: "/javascripts/categories.js"},receiveCategories);
                else if (changeInfo.url.indexOf("https://www.wanneroobusiness.com/member-details")==0){  //scrap conpanies data
